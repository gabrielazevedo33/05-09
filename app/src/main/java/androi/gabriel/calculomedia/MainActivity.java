package androi.gabriel.calculomedia;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        private void calcularMedia() {
            ...
            txtResultado.setText("aluno aprovadp com media"+media);
}
        }
    private void validaCampos() {
        if(TextUtils.isEmpty(nota1.getText())){
            nota1.setError("Esse campo nao pode estar Vazio");
        }else if(TextUtils.isEmpty(nota2.getText())) {
            nota2.setError("Esse campo nao pode estar Vazio");
            ...
            faltas.setError("Esse campo nao pode estar Vazio");
